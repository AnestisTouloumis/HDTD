...
The statistical methods implemented in `HDTD` are described in Touloumis et al. (2017), Touloumis et al. (2015) and Touloumis et al. (2016). Detailed examples of `HDTD` can be found in Touloumis et al. (2016) or in the vignette:
...
Touloumis, A., Marioni, J.C. and Tavaré, S. (2017) Hypothesis Testing for the Covariance Matrix in High-Dimensional Transposable Data with Kronecker Product Dependence Structure. *Submitted*.
