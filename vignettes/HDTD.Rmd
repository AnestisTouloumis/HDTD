...
```
Moreover, the user can study the gene-wise or tissue-wise correlation by using the `covmat.ts` function. For example, the results from the identity, sphericity and diagonality tests applied on the column variables
```{r}
